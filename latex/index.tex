Implementation of a bidirectional associative container in c++. Its goal is to behave similarly to popular stl containers like {\ttfamily std\+::unordered\+\_\+map} while providing efficient lookup from key to value as well as from value to key. \hypertarget{index_autotoc_md1}{}\doxysection{Properties}\label{index_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md2}{}\doxysection{Code Example}\label{index_autotoc_md2}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include "bidirectional\_map.hpp"}}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classbimap_1_1bidirectional__map}{bimap::bidirectional\_map<std::string, int>}} map;}
\DoxyCodeLine{map.emplace(\textcolor{stringliteral}{"NewItem"}, 17); \textcolor{comment}{// constructs new item in place}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// no insertion. 17 already exists in the container. Returns iterator to ("NewItem", 17)}}
\DoxyCodeLine{\textcolor{keyword}{auto} [iterator, inserted] = map.emplace(\textcolor{stringliteral}{"AnotherItem"}, 17);}
\end{DoxyCode}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{index_autotoc_md3}{}\doxysubsection{Inverse Access}\label{index_autotoc_md3}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md4}{}\doxysubsection{Custom Map Base Container}\label{index_autotoc_md4}
