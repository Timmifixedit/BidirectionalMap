\href{https://github.com/Timmifixedit/BidirectionalMap/actions/workflows/unit_tests.yml}{\texttt{ }} \hypertarget{index_autotoc_md0}{}\doxysubsection{bidirectional\+\_\+map}\label{index_autotoc_md0}
Implementation of a bidirectional associative container in c++. Its goal is to behave similarly to popular stl containers like {\ttfamily std\+::unordered\+\_\+map} while providing efficient lookup from key to value as well as from value to key. \hypertarget{index_autotoc_md1}{}\doxysubsubsection{Properties}\label{index_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md2}{}\doxysubsubsection{Doxygen Documentation}\label{index_autotoc_md2}

\begin{DoxyItemize}
\item \href{https://timmifixedit.github.io/BidirectionalMap/html/index.html}{\texttt{ H\+T\+ML}}
\item \href{https://timmifixedit.github.io/BidirectionalMap/BidirectionalMapDocs.pdf}{\texttt{ P\+DF}}
\end{DoxyItemize}\hypertarget{index_autotoc_md3}{}\doxysubsubsection{Code Example}\label{index_autotoc_md3}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{index_autotoc_md4}{}\doxyparagraph{Inverse Access}\label{index_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md5}{}\doxyparagraph{Custom Map Base Container}\label{index_autotoc_md5}
